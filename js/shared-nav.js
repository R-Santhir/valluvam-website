...
<footer class="footer">
  <div class="container">
    <div class="footer-grid">
      <div class="footer-brand">
        ...
        <div class="footer-social">
          <a href="https://www.instagram.com/valluvam_" class="social-icon" aria-label="Instagram" target="_blank" rel="noopener">
          ...
          <a href="https://www.facebook.com/profile.php?id=100069505203967" class="social-icon" aria-label="Facebook" target="_blank" rel="noopener">
            <svg viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
          </a>
          <a href="https://www.youtube.com/@valluvam8920" class="social-icon" aria-label="YouTube" target="_blank" rel="noopener">
    ...
    <div class="footer-bottom">
      ...
      <span>Registered Charity No. 726289739RR0001</span>
    </div>
  </div>
</footer>
`;
